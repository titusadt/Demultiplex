...
/usr/bin/time -v ./distribution.py -f $file_R1 -l 101 -p read1_plot.png
/usr/bin/time -v ./distribution.py -f $file_R2 -l 8 -p read2_plot.png
/usr/bin/time -v ./distribution.py -f $file_R3 -l 8 -p read3_plot.png
/usr/bin/time -v ./distribution.py -f $file_R4 -l 101 -p read4_plot.png